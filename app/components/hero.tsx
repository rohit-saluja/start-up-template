    ...
    <section className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="bg-gradient-to-r from-blue-500/10 dark:from-blue-500/20 to-purple-500/10 dark:to-purple-500/20 rounded-2xl p-8 backdrop-blur-sm border border-gray-200 dark:border-neutral-700">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="flex items-center justify-center flex-col">
                <Zap className="h-12 w-12 text-blue-400 mb-4" />
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Lightning Fast</h3>
                <p className="text-gray-600 dark:text-neutral-400 text-center">Deploy in under 30 seconds</p>
              </div>
              <div className="flex items-center justify-center flex-col">
                <Shield className="h-12 w-12 text-green-400 mb-4" />
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Secure by Default</h3>
                <p className="text-gray-600 dark:text-neutral-400 text-center">Enterprise-grade security</p>
              </div>
              <div className="flex items-center justify-center flex-col">
                ...
                <p className="text-gray-600 dark:text-neutral-400 text-center">Edge network worldwide</p>
              </div>
            </div>
            
            <div className="bg-gray-100/50 dark:bg-neutral-800/50 rounded-xl p-6 border border-gray-300 dark:border-neutral-600">
              <div className="flex items-center justify-between mb-4">
                ...
                <p className="text-gray-600 dark:text-neutral-400 text-sm">dashboard.startup.com</p>
              </div>
              <div className="bg-gray-200/30 dark:bg-black/30 rounded-lg p-4">
